...
Percorrer antes de entregar o projeto ao cliente. Use `/validar-projeto` para que o Claude percorra este checklist dentro da conversa, checando o que for possível checar de fato e sinalizando o resto como pendente de verificação humana.
